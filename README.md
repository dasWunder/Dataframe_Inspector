...
├── eda.py # Exploratory visualizations (distribution, correlation, etc.)

tests/
├── testing.ipynb # Manual tests and function usage examples
...
- Clean, modular design — easy to extend and maintain
